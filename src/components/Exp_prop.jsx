  ...
  return (
    <>
      <div className="relative flex items-start">
        <div className="ml-10 shadow-2xl rounded-3xl border-2 bg-[#e1e1e1] dark:bg-transparent border-[#00040f] p-8 hover:bg-gradient-to-tl from-[#e1e1e1] to-[#fff] dark:from-[#00040F] dark:to-[#0B274C]">
          <div className="HEADER flex">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[#00040f] dark:text-white text-lg">
                {props.subtitle}
              </p>
